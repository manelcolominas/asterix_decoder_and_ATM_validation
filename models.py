...
ITEM_SPECS = {
    ...
    DataItemType.I021_REF: DataItemTypeSpec(
        field_type=DataFieldType.COMPOUND,
        subfield_lengths=(1, 1, 1, 1, 1, 1, 1),
    ),
    ...
    DataItemType.I021_250: DataItemTypeSpec(
        field_type=DataFieldType.REPETITIVE,
        repetition_size=8,
    ),
    ...
    DataItemType.I048_130: DataItemTypeSpec(
        field_type=DataFieldType.COMPOUND,
        subfield_lengths=(1, 1, 1, 1, 1, 1, 1),
    ),
    ...
    DataItemType.I048_250: DataItemTypeSpec(
        field_type=DataFieldType.REPETITIVE,
        repetition_size=8,
    ),
